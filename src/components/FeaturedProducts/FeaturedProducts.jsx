...
const FeaturedProducts = ({type}) => {
  ...
  return (
    <div className='featuredProducts'>
      <div className="top">
        <h1>{type} Products</h1>
        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Fuga excepturi ipsum voluptatibus at, quis laboriosam sint voluptate optio eaque aperiam? Lorem ipsum dolor sit amet consectetur adipisicing elit. Expedita tempora quas beatae eaque, possimus mollitia!</p>
      </div>
